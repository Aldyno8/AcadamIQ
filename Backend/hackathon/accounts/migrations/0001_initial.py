    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('niveau', models.CharField(choices=[('Debutant', 'Debutant'), ('Intermediaire', 'Intermediaire'), ('Avance', 'Avance'), ('Expert', 'Expert'), ('Maitre', 'Maitre')], default='Debutant', max_length=25)),
